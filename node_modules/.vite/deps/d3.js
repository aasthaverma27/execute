...
function pie_default() {
  var value = identity_default4, sortValues = descending_default, sort2 = null, startAngle = constant_default8(0), endAngle = constant_default8(tau5), padAngle = constant_default8(0);
  function pie(data) {
...
function zoom_default2() {
  ...
  function dblclicked(event, ...args) {
    ...
    noevent_default3(event);
    if (duration > 0)
      select_default(this).transition().duration(duration).call(schedule, t13, p0, event);
    else
      select_default(this).call(zoom.transform, t13, p0, event);
  }
